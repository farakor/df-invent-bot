...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if current_step == 'name':
        ...
        try:
            ...
            # Округляем до 3 знаков после запятой для аккуратного отображения
            ...
            await update.message.reply_text("Пожалуйста, введите корректное число (можно использовать точку или запятую для десятичных):")
